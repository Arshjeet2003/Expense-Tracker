...
const GroupDetails = () => {
  ...
  return (
    <>
      <Navbar />
      <Sidebar />
      <div className="container outerMostBox">
        <div className="row">
          <div className="col-6 col-md-4 heading">
          ...
          <div className="col-6 col-md-4 upper-middle-box">
            <div className="button-box-detail">
              <button
                ...
                className="btn transparent bgroupdetails"
        ...
        <div className="row">
          <div className="col-md-3 col-sm-6 right">
            <div className="card card-members fixed-members ">
              <h4 className=" mt-3 mb-3">Group Members</h4>
              <div className="widget-wrap wrap wrap-for-members">
                <ul>
                  <div className="speech1 top">
                    {group.users?.map((user) => (
                      <div className="userList">
                        <li className="singleUser" key={user}>
                          {user}
                          <button
                            type="submit"
                          ...
                          >
                            <i className="material-symbols-outlined remove-user">
                              person_remove
                            </i>
                          </button>
          ...
          <div className="card card-square fixed-description">
            <h4 style={{ paddingLeft: 150 }} className=" mt-3 mb-3">
              Group Description
            </h4>
            <div className="widget-wrap wrap">
              <div className="speech top">{group.description}</div>
            </div>
          </div>
        </div>
      </div>
